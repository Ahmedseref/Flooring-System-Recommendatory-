...
export const BeakerIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
      <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 14.25-6.25 6.25m0 0-6.25-6.25M13.25 20.5V12.25m-2.5 8.25V12.25m0 0-6.25-6.25m6.25 6.25-6.25-6.25M3.5 7.5l6.25-6.25 6.25 6.25m-12.5 0v1.25c0 .621.504 1.125 1.125 1.125h10.25c.621 0 1.125-.504 1.125-1.125V7.5" />
    </svg>
);
